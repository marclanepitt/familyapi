"""
Django settings for tutory_api project.
...
WSGI_APPLICATION = 'tutory_api.wsgi.application'
...
SERVER_EMAIL = 'no.reply@tutory.com'
# Email address regular users receive mail from
DEFAULT_FROM_EMAIL = 'no.reply@tutory.com'
